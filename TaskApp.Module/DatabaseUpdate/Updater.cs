...
namespace TaskApp.Module.DatabaseUpdate
{
    ...
    public class Updater : ModuleUpdater
    {
        ...
        public override void UpdateDatabaseAfterUpdateSchema()
        {
            ...
            if (userManager.FindUserByName<ApplicationUser>(ObjectSpace, "Admin") == null)
            {
                ...
                _ = userManager.CreateUser<ApplicationUser>(ObjectSpace, "Admin", AdminPassword, (user) =>
                {
        ...
        PermissionPolicyRole CreateDefaultRole()
        {
            ...
            if (defaultRole == null)
            {
                ...
                // Permisos para Tarea
                defaultRole.AddTypePermissionsRecursively<Tarea>(SecurityOperations.ReadWriteAccess, SecurityPermissionState.Allow);
            }
            return defaultRole;
        }
    }
